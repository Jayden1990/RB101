...
# Second, where did that nil come from? 
# If we look at the if condition (value.size > 3), 
# we'll notice that it evaluates as true when the length of value is greater than 3. 
